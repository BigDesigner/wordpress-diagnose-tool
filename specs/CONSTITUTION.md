# WordPress Diagnose Tool - Standard Constitution (v1.1.3)

## The Law of Namespacing
As of version 1.1.3, the **Bracketed Namespace** structure is the absolute standard for all code within this project.
