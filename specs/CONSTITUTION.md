# WordPress Diagnose Tool - Standard Constitution (v1.2.1)

## The Law of Namespacing
As of version 1.2.1, the **Bracketed Namespace** structure is the absolute standard for all code within this project.
