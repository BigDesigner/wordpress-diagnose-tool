# WordPress Diagnose Tool - Standard Constitution (v0.3.2-beta)

## The Law of Namespacing
As of version 0.3.2-beta, the **Bracketed Namespace** structure is the absolute standard for all code within this project.
